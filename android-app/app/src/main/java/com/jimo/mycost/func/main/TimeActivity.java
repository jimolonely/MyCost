...
import com.jimo.mycost.func.time.TimeAddFragment;
import com.jimo.mycost.func.time.TimeShowFragment;
...
public class TimeActivity extends AppCompatActivity {
    ...
    private void initViews() {
        tv_title.setText("Time Cost");

        titles.add("Add");
        titles.add("Show");

        fragments.add(new TimeAddFragment());
        fragments.add(new TimeShowFragment());
