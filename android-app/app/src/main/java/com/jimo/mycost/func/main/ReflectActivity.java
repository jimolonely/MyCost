...
import com.jimo.mycost.func.reflect.ReflectAddFragment;
import com.jimo.mycost.func.reflect.ReflectShowFragment;
...
public class ReflectActivity extends AppCompatActivity {
    ...
    private void initViews() {
        tv_title.setText("Reflection Record");

        titles.add("Add");
        titles.add("Show");

        fragments.add(new ReflectAddFragment());
        fragments.add(new ReflectShowFragment());
