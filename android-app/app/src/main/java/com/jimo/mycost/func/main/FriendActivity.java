...
import com.jimo.mycost.func.friend.FriendAddFragment;
import com.jimo.mycost.func.friend.FriendShowFragment;
...
public class FriendActivity extends AppCompatActivity {
    ...
    private void initViews() {
        tv_title.setText("Friend");

        titles.add("Add");
        titles.add("Show");

        fragments.add(new FriendAddFragment());
        fragments.add(new FriendShowFragment());
